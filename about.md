# About Aalenia
The Aalenian community is the home of the Aalenian Modifications Path of Titans (PoT) modding team and associated PoT community servers. Path of Titans is a 
massively multiplayer online dinosaur simulation game which allows game owners to host their own "community servers" which can implement game modifications ("mods") or use third-party applications to customise the play experience. The gaming community typiclly refers to such applications as "bots".
## Origin
...
## Name
This community is named after the "Aalenian" age, an age of the Middle Jurrasic whose prehistoric context resonates with the content created herein.